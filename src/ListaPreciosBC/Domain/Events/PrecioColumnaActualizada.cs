...
namespace ListaPreciosBC.Domain.Events
{
    public sealed class PrecioColumnaActualizada : DomainEvent
    {
        ...
        public PrecioColumnaActualizada(EmpresaId empresaId, Guid? establecimientoId, ProductoId productoId, IdentificadorColumnaPrecio columna, DateTimeOffset ocurrioEn)
