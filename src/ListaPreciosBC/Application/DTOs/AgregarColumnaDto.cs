...
namespace ListaPreciosBC.Application.DTOs
{
    ...
    public class AgregarColumnaDto
    {
        ...
        public string TipoColumnaCodigo { get; set; } = TipoColumnaPrecio.Manual.Codigo;
        public string? TipoReglaGlobalCodigo { get; set; }
        public decimal? ValorReglaGlobal { get; set; }
