...
{
	/// <summary>
	/// Consume una reserva (confirma y egresa del stock la misma cantidad, liberando la reserva).
	/// </summary>
	public sealed class ConsumirReservaStockUseCase
	{
		...
		public ConsumirReservaStockUseCase(IReservaStockRepository reservaRepo, IStockPorAlmacenRepository stockRepo, ITenantContext tenant, IUnitOfWork uow)
		{
		...
		public async Task<Response> Handle(Request req, CancellationToken ct)
		{
			...
			reserva.Confirmar();
			stock.LiberarReserva(reserva.Cantidad); // deja de estar reservado
			stock.Egresar(reserva.Cantidad);        // egreso físico
