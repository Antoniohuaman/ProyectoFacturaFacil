...
{
	/// <summary>
	/// Actualiza el nombre de un almacén existente.
	/// </summary>
	public sealed class ActualizarAlmacenUseCase
	{
		...
		public ActualizarAlmacenUseCase(IAlmacenRepository repo, ITenantContext tenant, IUnitOfWork uow)
		{
		...
		public async Task<Response> Handle(Request req, CancellationToken ct)
		{
			...
			agregado.ActualizarNombre(req.NuevoNombre);
