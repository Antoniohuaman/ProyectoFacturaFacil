// src/GestionCobranzasBC/Application/UseCases/RegistrarCobranzaPorCuotaUseCase.cs
...
public sealed class RegistrarCobranzaPorCuotaUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var resultado = await _cobranzasDomainService
            .RegistrarCobranzaPorCuotaAsync(comando, cancellationToken)
