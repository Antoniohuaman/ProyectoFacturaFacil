// src/GestionCobranzasBC/Application/UseCases/RegistrarCobranzaParcialUseCase.cs
...
public sealed class RegistrarCobranzaParcialUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var resultado = await _cobranzasDomainService
            .RegistrarCobranzaParcialAsync(comando, cancellationToken)
