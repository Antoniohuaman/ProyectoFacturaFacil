...
{
    /// <summary>
    /// DTO de salida de RegistrarAnulacionVenta.
    /// Devuelve el estado y los totales del agregado tras la operación.
    /// </summary>
    public sealed class RegistrarAnulacionVentaOutputDto
    {
        ...
        public RegistrarAnulacionVentaOutputDto(
            Guid indicadorId,
