...
using ListaPreciosBC.Domain.ValueObjects;    // IdentificadorColumnaPrecio, NombreColumnaPrecio, ModoValorizacionColumna, ValorPrecio, PeriodoVigencia, TramoVolumen, MatrizVolumen, Sku
...
namespace ListaPreciosBC.Tests.Application.UseCases
{
    public class ListarPreciosDeSkuUseCaseTests
    {
        ...
        public async Task ListarPrecios_Exito_TraePorCadaColumna_PreciosVigentesYNulls()
        {
            ...
            var sut = new ListarPreciosDeSkuUseCase(listaRepo, precioRepo, new TenantContextFake());
