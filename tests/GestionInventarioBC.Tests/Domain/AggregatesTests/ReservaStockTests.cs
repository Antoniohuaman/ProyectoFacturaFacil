...
namespace GestionInventarioBC.Tests.Aggregates
{
	...
	public class ReservaStockTests
	{
		...
		public void Crear_inicia_Pendiente_y_setea_vencimiento_opcional()
		{
			...
			var r = ReservaStock.Crear(E, S, A, P(), new CantidadStock(2m), vence);
		...
		{
			var r = ReservaStock.Crear(E, S, A, P(), new CantidadStock(1m), null);
			r.Confirmar();
			...
			var r2 = ReservaStock.Crear(E, S, A, P(), new CantidadStock(1m), null);
			r2.Liberar();
			Assert.That(r2.Estado, Is.EqualTo(EstadoReserva.Liberada));

			var r3 = ReservaStock.Crear(E, S, A, P(), new CantidadStock(1m), null);
			r3.Vencer();
			Assert.That(r3.Estado, Is.EqualTo(EstadoReserva.Vencida));

			var r4 = ReservaStock.Crear(E, S, A, P(), new CantidadStock(1m), null);
			r4.Cancelar();
